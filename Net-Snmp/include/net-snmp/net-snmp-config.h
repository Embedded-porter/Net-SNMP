...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr/local/snmp' '--with-mib-modules=a' '--with-default-snmp-version=2' '--with-sys-contact=contact@contact' '--with-sys-location=China' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/net-snmp'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/usr/local/snmp/share/snmp/mibs"
...
#define SNMPLIBPATH "/usr/local/snmp/lib/snmp"
#define SNMPSHAREPATH "/usr/local/snmp/share/snmp"
#define SNMPCONFPATH "/usr/local/snmp/etc/snmp"
#define SNMPDLMODPATH "/usr/local/snmp/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "contact@contact"
